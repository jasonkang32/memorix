...
class CameraCaptureSupportTest {
    ...
    fun fileProviderAuthority_usesPackageNameSuffix() {
        val result = CameraCaptureSupport.fileProviderAuthority("com.mebonsoft.memorix")

        assertEquals("com.mebonsoft.memorix.fileprovider", result)
    }
    ...
    fun pendingPhotoCapture_toImportRequest_marksPhotoType() {
        val pending = PendingCameraCapture(
            ...
            outputUri = Uri.parse("content://com.mebonsoft.memorix.fileprovider/memorix-camera/camera_capture.jpg"),
            authority = "com.mebonsoft.memorix.fileprovider",
        )
